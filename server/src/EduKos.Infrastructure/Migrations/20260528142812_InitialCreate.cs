    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Institutions_Users_OwnerUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserEducationHistory", x => x.EducationHistoryId);
                    table.ForeignKey(
                        name: "FK_UserEducationHistory_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UserInterestId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<int>(type: "int", nullable: false),
                    InterestName = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserProfiles_Files_ProfileImageFileId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SelectedProgram = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InstitutionAnnouncements", x => x.AnnouncementId);
                    table.ForeignKey(
                        name: "FK_InstitutionAnnouncements_Institutions_InstitutionId",
                        column: x => x.InstitutionId,
                        principalTable: "Institutions",
                        principalColumn: "InstitutionId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InstitutionContacts", x => x.ContactId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    InstitutionDetailId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    InstitutionId = table.Column<int>(type: "int", nullable: false),
                    ...
                    OutdoorSpaces = table.Column<bool>(type: "bit", nullable: true),
                    SecurityInfo = table.Column<string>(type: "text", nullable: true),
                    GradesOffered = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    ECTSInfo = table.Column<string>(type: "text", nullable: true),
                    ExchangePrograms = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_InstitutionDetails", x => x.InstitutionDetailId);
                    table.ForeignKey(
                        name: "FK_InstitutionDetails_Institutions_InstitutionId",
                        column: x => x.InstitutionId,
                        principalTable: "Institutions",
                        principalColumn: "InstitutionId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InstitutionFacilities", x => x.FacilityId);
                    table.ForeignKey(
                        name: "FK_InstitutionFacilities_Institutions_InstitutionId",
                        column: x => x.InstitutionId,
                        principalTable: "Institutions",
                        principalColumn: "InstitutionId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TuitionFee = table.Column<decimal>(type: "decimal(10,2)", nullable: true),
                    ECTS = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_InstitutionPrograms", x => x.ProgramId);
                    table.ForeignKey(
                        name: "FK_InstitutionPrograms_Institutions_InstitutionId",
                        column: x => x.InstitutionId,
                        principalTable: "Institutions",
                        principalColumn: "InstitutionId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InstitutionStaff", x => x.StaffId);
                    table.ForeignKey(
                        name: "FK_InstitutionStaff_Files_PhotoFileId",
                        column: x => x.PhotoFileId,
                        principalTable: "Files",
                        principalColumn: "FileId",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_InstitutionStaff_Institutions_InstitutionId",
                        column: x => x.InstitutionId,
                        principalTable: "Institutions",
                        principalColumn: "InstitutionId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Recommendations_Institutions_InstitutionId",
                        column: x => x.InstitutionId,
                        principalTable: "Institutions",
                        principalColumn: "InstitutionId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<int>(type: "int", nullable: false),
                    InstitutionId = table.Column<int>(type: "int", nullable: false),
                    TeachingQualityRating = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                name: "SavedInstitutions",
                columns: table => new
                {
                    SavedInstitutionId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<int>(type: "int", nullable: false),
                    InstitutionId = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETDATE()")
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SavedInstitutions", x => x.SavedInstitutionId);
                    table.ForeignKey(
                        name: "FK_SavedInstitutions_Institutions_InstitutionId",
                        column: x => x.InstitutionId,
                        principalTable: "Institutions",
                        principalColumn: "InstitutionId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SavedInstitutions_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "UserId");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InstitutionAnnouncements_InstitutionId",
                table: "InstitutionAnnouncements",
                column: "InstitutionId");

            migrationBuilder.CreateIndex(
                name: "IX_InstitutionContacts_InstitutionId",
                table: "InstitutionContacts",
                column: "InstitutionId");

            migrationBuilder.CreateIndex(
                name: "IX_InstitutionDetails_InstitutionId",
                table: "InstitutionDetails",
                column: "InstitutionId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_InstitutionFacilities_InstitutionId",
                table: "InstitutionFacilities",
                column: "InstitutionId");

            migrationBuilder.CreateIndex(
                name: "IX_InstitutionPrograms_InstitutionId",
                table: "InstitutionPrograms",
                column: "InstitutionId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Institutions_OwnerUserId",
                table: "Institutions",
                column: "OwnerUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InstitutionStaff_PhotoFileId",
                table: "InstitutionStaff",
                column: "PhotoFileId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Recommendations_InstitutionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SavedInstitutions_InstitutionId",
                table: "SavedInstitutions",
                column: "InstitutionId");

            migrationBuilder.CreateIndex(
                name: "IX_SavedInstitutions_UserId_InstitutionId",
                table: "SavedInstitutions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserProfiles_ProfileImageFileId",
                table: "UserProfiles",
