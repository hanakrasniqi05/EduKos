...
namespace EduKos.Infrastructure.Migrations
{
    ...
    [Migration("20260606124258_AddSqlRtcCommunication")]
    partial class AddSqlRtcCommunication
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EduKos.Domain.Entities.Conversation", b =>
                {
                    ...
                    b.HasIndex("Type", "StudentUserId", "InstitutionId", "AdminUserId")
                        .IsUnique()
                        .HasFilter("[StudentUserId] IS NOT NULL AND [AdminUserId] IS NOT NULL");
